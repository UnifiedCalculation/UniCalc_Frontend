...
import {getArticles} from "../../connectionHandler/connectionHandler";
...
function fillArticles() {
  setArticles(getArticles(setErrorMessage, setArticles));
  createData(articles.npk, articles.id, articles.title, articles.price, articles.unit, articles.description)
}
